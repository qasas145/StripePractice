        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyEmailLimit = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasPremiumFeatures = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1000, "Basic", "price_basic_placeholder" },
                    { 2, 10000, "Premium", "price_premium_placeholder" }
                });
